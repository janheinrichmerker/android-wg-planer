...
import com.heinrichreimersoftware.wg_planer.adapters.TimetableAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        loader = new ListLoader<>(adapter, new ListLoader.Task<Lesson>() {
            ...
            public List<Lesson> load() {
                ...
                return TimetableContentHelper.getTimetable(getActivity(), day);
            }
        });
        loader.load();
    ...
    private void requestSync() {
        ...
        if (accountManager != null) {
            for (Account account : accountManager.getAccountsByType(AccountGeneral.ACCOUNT_TYPE)) {
                ContentResolver.requestSync(account, TimetableContract.AUTHORITY, bundle);
            }
        }
    }
}
