...
import com.heinrichreimersoftware.wg_planer.databinding.ItemRepresentationBinding;
...
public class RepresentationAdapter extends ListAdapter<Representation, RepresentationAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup container, int viewType) {
        ItemRepresentationBinding binding = ItemRepresentationBinding.inflate(LayoutInflater.from(container.getContext()), container, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ItemRepresentationBinding binding;
