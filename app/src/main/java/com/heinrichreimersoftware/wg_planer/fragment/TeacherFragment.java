...
import com.heinrichreimersoftware.wg_planer.adapter.TeacherAdapter;
...
public class TeacherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.title_fragment_teacher);
        ...
        loader = new ListLoader<>(adapter, new ListLoader.Task<Teacher>() {
            @Override
            public List<Teacher> load() {
                return Arrays.asList(TeachersContentHelper.getTeachers(getActivity()));
            }
        });
        loader.load();

        syncStatusManager = new SyncStatusManager(getActivity(), Constants.CONTENT_AUTHORITY_TEACHERS);
    ...
    private void requestSync() {
        ...
        if (accountManager != null) {
            for (Account account : accountManager.getAccountsByType(AccountGeneral.ACCOUNT_TYPE)) {
                ContentResolver.requestSync(account, Constants.CONTENT_AUTHORITY_TEACHERS, bundle);
            }
        }
    }
}
