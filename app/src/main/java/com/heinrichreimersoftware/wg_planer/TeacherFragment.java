...
import com.heinrichreimersoftware.wg_planer.adapters.TeacherAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        loader = new ListLoader<>(adapter, new ListLoader.Task<Teacher>() {
            ...
            public List<Teacher> load() {
                return TeachersContentHelper.getTeachers(getActivity());
            }
        });
        loader.load();

        syncStatusManager = new SyncStatusManager(getActivity(), TeachersContract.AUTHORITY);
    ...
    private void requestSync() {
        ...
        if (accountManager != null) {
            for (Account account : accountManager.getAccountsByType(AccountGeneral.ACCOUNT_TYPE)) {
                ContentResolver.requestSync(account, TeachersContract.AUTHORITY, bundle);
            }
        }
    }
}
